# .github
Organization policy and shared workflows for scintilla-run-test


<!-- ore-org-baseline:begin -->
## Organization-wide defaults

This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`scintilla-run-test`](https://github.com/scintilla-run-test).

## Canonical organization links

- GitHub organization: https://github.com/scintilla-run-test
- Public organization defaults: https://github.com/scintilla-run-test/.github
